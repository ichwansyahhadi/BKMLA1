              ...
              <div class="col-sm-12 col-md-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    echo form_open_multipart("Admin/ManageEvent/update/".$eventData->id, $attributes);
                    ?>
                      <div class="col-md-12">
                        <label for="title">Event Title:</label>
                        <input type="text" id="title" class="form-control" name="title" value="<?php echo $eventData->title?>">
                      </div>
                      <div class="col-md-12">
                        &nbsp;
                      </div>
                      <div class="col-md-6">
                        ...
                        <input type="text" name="date" id="date" class="form-control" value="<?php echo date('m/d/Y',strtotime($eventData->date_start)).' - '.date('m/d/Y',strtotime($eventData->date_end)) ?>">
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" id="lang" class="form-control" name="lang" value="<?php echo $eventData->geo_lang;?>">
                      </div>
                      <div class="col-md-6">
                        <label for="title">Event Longitude:</label>
                        <input type="text" id="long" class="form-control" name="long" value="<?php echo $eventData->geo_long; ?>" >
                      </div>
                      <div class="col-md-12">
                        &nbsp;
                      </div>
                      <div class="col-md-12">
                        ...
                        <textarea name="description" id="description"><?php echo $eventData->description?></textarea>
                      </div>
                      <div class="col-md-12">
                        &nbsp;
                      </div>
                      ...
                      <div class="col-sm-12">
                        <div class="input-group">
                          <img id="picture" style='width:100%;' border="0" src="<?php echo base_url().$eventData->img_path; ?>"></img>
                        </div>
                      </div>
                    <?php echo form_close(); ?>
                    </div>
